...
func (c *Handler) Create() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		_, span := trace.StartSpan(r.Context(), "datastore.users.Exists")
		...
		_, span = trace.StartSpan(r.Context(), "datastore.users.Add")
		err = c.repo.Add(user)
		span.End()
...
func (c *Handler) Delete() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		_, span := trace.StartSpan(r.Context(), "datastore.users.Remove")
